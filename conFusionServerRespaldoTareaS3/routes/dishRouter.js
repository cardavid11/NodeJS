...
dishRouter.route('/')
    ...
    .put(authenticate.verifyOrdinaryUser, authenticate.verifyAdmin, function (req, res, next) {
        res.statusCode = 403;
        res.end('PUT operation not supported on /dishes');
    })
    .delete(authenticate.verifyOrdinaryUser, authenticate.verifyAdmin, function (req, res, next) {
        Dishes.remove({})
            .then((resp) => {
                res.statusCode = 200;
                res.setHeader('Content-Type', 'application/json');
